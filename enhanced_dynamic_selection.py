...
class DESModelEvaluator:
    ...
    def generate_classifier_pools(self, models, top_k=7, random_state=42, fold=1):
        ...
        # 增强数据保存路径，包含折数信息
        enhance_data_dir = os.path.join("enhance_data", "HE", f"fold{fold}")
    ...
    def evaluate_methods(self, random_state=42):
        ...
        methods = {
            ...
            # 'DESKNN': (DESKNN, {'k': 7}),
            # # 静态集成方法
            # # 'single_best': (SingleBest, {'scoring': 'f1'}),
            # # 'StaticSelection': (StaticSelection, {'scoring': 'f1'}),
            # # 'StackedClassifier': (StackedClassifier, {}),

            # # 论文中关于动态模糊超盒实验参数设置
            # 'FH_1p': (FHDES_JFB_vector, {'theta':.27, 'mu':.99, 'mis_sample_based':False,
            #               'doContraction':False, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_2p': (FHDES_JFB_vector, {'theta':0.001, 'mu': 0.4, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':False, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_3p': (FHDES_Allboxes_vector, {'theta':.8, 'mu':.1, 'mis_sample_based':False,
            #               'doContraction':False, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_4p': (FHDES_Allboxes_vector, {'theta':0.001, 'mu': 0.4, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':False, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_5p': (FHDES_Allboxes_vector, {'theta':.8, 'mu':.3, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_6p': (DESFHMW_JFB_vector, {'theta':.99, 'mu':.4, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_7p': (FHDES_Allboxes_vector, {'theta':.8, 'mu':.1, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_8p': (DESFHMW_allboxes_vector, {'theta':.99, 'mu':.1, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_9p': (FHDES_prior_vector, {'theta':.99, 'mu':.2, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_10p': (DESFHMW_prior_vector, {'theta':.8, 'mu':.6, 'mis_sample_based':False,
            #               'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),

            # 'FH_1v': (FHDES_JFB_vector, {'theta':.6, 'mu':.1, 'mis_sample_based':True,
            #                         'doContraction':False, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_2v': (FHDES_JFB_vector, {'theta':0.001, 'mu':.4, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':False, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_3v': (FHDES_Allboxes_vector, {'theta':.5, 'mu':.3, 'mis_sample_based':True,
            #                          'doContraction':False, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_4v': (FHDES_Allboxes_vector, {'theta':0.001, 'mu':.1, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':False, 'multiCore_process':False, 'shuffle_dataOrder':False}),
            # 'FH_5v': (FHDES_JFB_vector, {'theta':.7, 'mu':.1, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_6v': (DESFHMW_JFB_vector, {'theta':.7, 'mu':.5, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_7v': (FHDES_Allboxes_vector, {'theta':.4, 'mu':.4, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_8v': (DESFHMW_allboxes_vector, {'theta':.5, 'mu':.4, 'mis_sample_based':True,
            #                          'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_9v': (FHDES_prior_vector, {'theta':.7, 'mu':.7, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            # 'FH_10v': (DESFHMW_prior_vector, {'theta':.9, 'mu':.7, 'mis_sample_based':True,
            #                         'doContraction':True, 'thetaCheck':True, 'multiCore_process':True, 'shuffle_dataOrder':False}),
            ...
            #     }
            # ),
            # # 消融实验1: 仅使用基础隶属度，去除增强因子
            # 'FH_DA_wo_enhancement': (
            #     FHDES_JFB_vector_clustering_optimized, 
            #     {
            #         'theta':0.001, 'mu':.4, 'mis_sample_based':True,
            #         'doContraction':True, 'thetaCheck':False, 'multiCore_process':True, 'shuffle_dataOrder':False,
            ...
            #         'use_pca': False, 'pca_components': 6, 'normalize_weights': False, 'normalize_correlations': True, 
            #         'bandwidth': 0.315023760097458, 'density_weight': 0.15000000000000002, 'cluster_distance_weight': 0.584526702261065, 
            #         'basic_weight': 1.0, 'enhancement_weight': 0.0, 'epsilon': 4.4875730462234466e-08
            #      }
            # ),
            # 'FH_DA_ellipsoidal_wo_enhancement': (
            #     FHDES_JFB_vector_he_clustering_optimized,
            #     {
            #         'theta': 0.001,
            #         'mu': 0.4,
            ...
            #     }
            # ),
            # 'FH_DA_spherical_wo_enhancement': (
            #     FHDES_AllBoxes_vector_sphere_clustering_optimized,
            #     {
            #         'mis_sample_based': True,
            #         'doContraction': False,
            ...
            #     }
            # ),
            # 'FH_DA_bi-slope_rectangular_wo_enhancement': (
            #     FHDES_AllBoxes_vector_rectangle_clustering_optimized,
            #     {
            #         'n_clusters': 5,
            #         'bandwidth_selection': 'silverman',
            ...
            #     }
            # ),
            # # 消融实验2: 仅保留基础参数，去除聚类和局部密度信息
            # 'FH_DA_wo_cluster_density': (
            #     FHDES_JFB_vector_clustering_optimized, 
            #     {
            #         'theta':0.001, 'mu':.4, 'mis_sample_based':True,
            #         'doContraction':True, 'thetaCheck':False, 'multiCore_process':True, 'shuffle_dataOrder':False
            #      }
            # ),
            # 'FH_DA_ellipsoidal_wo_cluster_density': (
            #     FHDES_JFB_vector_he_clustering_optimized,
            #     {
            #         'theta': 0.001,
            #         'mu': 0.4,
            ...
            #     }
            # ),
            # 'FH_DA_spherical_wo_cluster_density': (
            #     FHDES_AllBoxes_vector_sphere_clustering_optimized,
            #     {
            #         'theta': 0.8277044306380984,
            #         'mu': 0.45000000000000007,
            ...
            #     }
            # ),
            # 'FH_DA_bi-slope_rectangular_wo_cluster_density': (
            #     FHDES_AllBoxes_vector_rectangle_clustering_optimized,
            #     {
            #         'theta': 0.001,
            #         'mu': 0.4,
            ...
            'FH_DA_bi-slope_rectangular_wo_enhance': (
                FHDES_AllBoxes_vector_rectangle_clustering_optimized,
                {
                    'theta': 0.001,
                    'mu': 0.4,
            ...
            #     'knn_k': 6, 'use_pca': False, 'pca_components': 9, 'normalize_weights': False, 'normalize_correlations': False, 
            #     'bandwidth': 2.7975701046328614, 'theta': 0.6870950482390474, 'mu': 0.2, 'density_weight': 0.75, 
            #     'cluster_distance_weight': 0.6071418086421805, 'basic_weight': 1.0, 
            #     'enhancement_weight': 0.0, 'epsilon': 1.3133080552399374e-08}
            #     ),
            # 'FH_DA_ellipsoidal_wo_enhance': (
            #         FHDES_Allboxes_vector_he_clustering_optimized,
            #         {'mis_sample_based': True, 'doContraction': False, 'thetaCheck': False, 'multiCore_process': False, 
            ...
            #         'knn_k': 4, 'use_pca': True, 'pca_components': 7, 'normalize_weights': False, 'normalize_correlations': True, 
            #         'bandwidth': 0.9145187314549602, 'theta': 0.9088200252575138, 'mu': 0.6, 'density_weight': 0.45000000000000007, 
            #         'cluster_distance_weight': 0.721175651859676, 'basic_weight': 1.0, 'enhancement_weight': 0.0, 
            #         'epsilon': 7.580429004146923e-08, 'gamma': 0.1177623190541896, 'reg_lambda': 4.2930177392983695e-05}
            #     ),  
            # 'FH_DA_spherical_wo_enhance': (
            #     FHDES_AllBoxes_vector_sphere_clustering_optimized,
            ...
            #     'normalize_correlations': True, 'bandwidth': 0.2783297834037277, 'theta': 0.5107073270264305, 
            #     'mu': 0.15000000000000002, 'density_weight': 0.65, 'cluster_distance_weight': 0.41129475125766113, 
            #     'basic_weight': 1.0, 'enhancement_weight': 0.0, 
            #     'epsilon': 8.728214380908525e-08, 'sigma': 0.8850706481483924}
            #    ),      
            # 'FH_DA_bi-slope_rectangular_wo_enhance': (
            #     FHDES_AllBoxes_vector_rectangle_clustering_optimized,
            ...
            #     'knn_k': 4, 'use_pca': True, 'pca_components': 10, 'normalize_weights': True, 'normalize_correlations': True, 
            #     'bandwidth': 0.5614924866063653, 'theta': 0.5705753278606428, 'mu': 0.55, 'density_weight': 0.65, 
            #     'cluster_distance_weight': 0.7982400774120468, 'basic_weight': 1.0, 'enhancement_weight': 0.0, 
            #     'epsilon': 4.573243428322887e-08, 'alpha': 1.0269641738184827, 'beta': 0.5108427899165016}
            #     ),    
            # # 消融实验2: ACLF-改进超盒变体去除聚类和局部密度信息
            # 'FH_DA_wo_cluster_density': (
            #     FHDES_Allboxes_vector_clustering_optimized,
            #     {'mis_sample_based': True, 'doContraction': True, 'thetaCheck': True, 'multiCore_process': False, 
            #     'shuffle_dataOrder': True, 'theta': 0.6870950482390474, 'mu': 0.2}
            #     ),
            # 'FH_DA_ellipsoidal_wo_cluster_density': (
            #         FHDES_Allboxes_vector_he_clustering_optimized,
            #         {'mis_sample_based': True, 'doContraction': False, 'thetaCheck': False, 'multiCore_process': False, 
            #         'shuffle_dataOrder': True, 'theta': 0.9088200252575138, 'mu': 0.6, 
            #         'gamma': 0.1177623190541896, 'reg_lambda': 4.2930177392983695e-05}
            #     ),  
            # 'FH_DA_spherical_wo_cluster_density': (
            #     FHDES_AllBoxes_vector_sphere_clustering_optimized,
            #     {'mis_sample_based': True, 'doContraction': True, 'thetaCheck': False, 
            #     'multiCore_process': True, 'shuffle_dataOrder': False, 'theta': 0.5107073270264305, 
            #     'mu': 0.15000000000000002, 'sigma': 0.8850706481483924}
            #    ),      
            # 'FH_DA_bi-slope_rectangular_wo_cluster_density': (
            #     FHDES_AllBoxes_vector_rectangle_clustering_optimized,
            #     {'mis_sample_based': True, 'doContraction': True, 'thetaCheck': False, 'multiCore_process': False, 
            #     'shuffle_dataOrder': True, 'theta': 0.5705753278606428, 'mu': 0.55, 
            #     'alpha': 1.0269641738184827, 'beta': 0.5108427899165016}
            #     ),    
...
if __name__ == "__main__":
    ...
    for fold in range(1, num_folds + 1):
        ...
        synthetic_datasets = load_datasets_from_folder(
            folder_path='filtered_data/HE',
            # _disease_attention_pca    /enhance/default：PD_final_train_fold_  PD_enhanced_gaussian_copula_fold_
            file_extension='.csv', prefix=f'HE_final_train_fold_{fold}')

        # 得到测试集
        test_set = pd.read_csv(f"filtered_data/HE/HE_final_test_fold_{fold}.csv")
        X_test = test_set.iloc[:, :-1]
        y_test = test_set.iloc[:, -1]

        # # 得到外部验证集
        # test_set = pd.read_csv(f"filtered_externel_data/HE_external_preprocessed_0.4-0.1.csv")
        # X_test = test_set.iloc[:, :-1]
        # y_test = test_set.iloc[:, -1]

        # 得到动态选择集
        desl_set = pd.read_csv(f'filtered_data/HE/HE_final_desl_fold_{fold}.csv')
        ...
        evaluator.generate_classifier_pools(models, top_k=7, random_state=42, fold=fold)
