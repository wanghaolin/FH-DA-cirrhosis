...
class DESFHMW_JFB_vector(BaseDES):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        super(DESFHMW_JFB_vector, self).__init__(pool_classifiers=pool_classifiers,
                                    with_IH=with_IH,
                                    safe_k=safe_k,
                                    IH_rate=IH_rate,
    ...
    def fit(self, X, y):
        super(DESFHMW_JFB_vector, self).fit(X, y)
    ...
    def FMM_train(self, classifier_ind):
        ...
        for ind, x in enumerate(X):
            ...
            if self.is_expandable(hboxV, hboxW, nearestBox_ind, x):
                ...
                self.contract_boxBased(hboxV[nearestBox_ind], hboxW[nearestBox_ind], coboxV,coboxW )
                continue
