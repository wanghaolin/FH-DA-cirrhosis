...
class DESFHMW_prior_vector_he_clustering(DESFHMW_prior_vector_he):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        # 调用父类初始化
        super(DESFHMW_prior_vector_he_clustering, self).__init__(
    ...
    def fit(self, X, y):
        ...
        """
        super(DESFHMW_prior_vector_he_clustering, self).fit(X, y)
    ...
    def estimate_competence(self, query, neighbors=None, distances=None, predictions=None):
        ...
        basic_competences = super(DESFHMW_prior_vector_he_clustering, self).estimate_competence(
    ...
    def FMM_train(self, classifier_ind):
        ...
        centers, cov_matrices = super(DESFHMW_prior_vector_he_clustering, self).FMM_train(classifier_ind)
