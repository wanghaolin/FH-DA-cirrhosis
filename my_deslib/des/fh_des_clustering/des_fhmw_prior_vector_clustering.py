...
class DESFHMW_prior_vector_clustering(DESFHMW_prior_vector):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        # 调用父类初始化
        super(DESFHMW_prior_vector_clustering, self).__init__(
    ...
    def fit(self, X, y):
        # 调用父类fit方法
        super(DESFHMW_prior_vector_clustering, self).fit(X, y)
    ...
    def estimate_competence(self, query, neighbors=None, distances=None, predictions=None):
        ...
        basic_competences = super(DESFHMW_prior_vector_clustering, self).estimate_competence(
    ...
    def FMM_train(self, classifier_ind):
        ...
        hboxV, hboxW = super(DESFHMW_prior_vector_clustering, self).FMM_train(classifier_ind)
