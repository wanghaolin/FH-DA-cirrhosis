...
class FHDES_JFB_vector_clustering(FHDES_JFB_vector):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        # 调用父类初始化
        super(FHDES_JFB_vector_clustering, self).__init__(
    ...
    def fit(self, X, y):
        # 调用父类fit方法
        super(FHDES_JFB_vector_clustering, self).fit(X, y)
    ...
    def estimate_competence(self, query, neighbors=None, distances=None, predictions=None):
        ...
        basic_competences = super(FHDES_JFB_vector_clustering, self).estimate_competence(
    ...
    def setup_hyperboxs(self, classifier):
        ...
        hboxV, hboxW = super(FHDES_JFB_vector_clustering, self).setup_hyperboxs(classifier)
