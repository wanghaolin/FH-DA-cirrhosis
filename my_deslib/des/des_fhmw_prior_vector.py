...
class DESFHMW_prior_vector(BaseDES):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        super(DESFHMW_prior_vector, self).__init__(pool_classifiers=pool_classifiers,
                                    with_IH=with_IH,
                                    safe_k=safe_k,
                                    IH_rate=IH_rate,
    ...
    def will_not_overlap(self, bV, bW, coboxV , coboxW):
    ...
    def fit(self, X, y):
        super(DESFHMW_prior_vector, self).fit(X, y)
    ...
    def FMM_train(self, classifier_ind):
        ...
        for ind, x in enumerate(X):
            ...
            for ind in sorted_indexes:
                if self.is_expandable(hboxV, hboxW, ind, x) and self.will_not_overlap(hboxV[ind], hboxW[ind], coboxV, coboxW):
