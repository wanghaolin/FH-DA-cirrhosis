...
class FHDES_prior_vector_sphere(BaseDES):
    ...
    def __init__(self, pool_classifiers=None,
        ...
        super(FHDES_prior_vector_sphere, self).__init__(pool_classifiers=pool_classifiers,
                                    with_IH=with_IH,
                                    safe_k=safe_k,
                                    IH_rate=IH_rate,
    ...
    def fit(self, X, y):
        super(FHDES_prior_vector_sphere, self).fit(X, y)
