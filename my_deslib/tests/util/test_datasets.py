import pytest
import numpy as np
from my_deslib.util.datasets import make_P2
from my_deslib.util.datasets import make_banana
from my_deslib.util.datasets import make_banana2
from my_deslib.util.datasets import make_circle_square
from my_deslib.util.datasets import make_xor
